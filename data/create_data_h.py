...
def create_csv(fname, y, input_dir, images_dir, csv_filename):
    ...
    for filename, label in zip(fname, y):
        ...
        for image_filename in list_image_filename:
            image_path = os.path.join(input_dir, images_dir, name, image_filename)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-images", "--images_dir", default="images")
    ...
    create_csv(fname_train, y_train, input_dir, images_dir, "train_8_2.csv")
    create_csv(fname_val, y_val, input_dir, images_dir, "val_8_2.csv")
