...
def create_csv(fname, y, input_dir, csv_filename):
    ...
    for filename, label in zip(fname, y):
        ...
        list_image_filename = sorted(os.listdir(os.path.join(input_dir, 'images', name)))
...
if __name__ == '__main__':
    ...
    fname_train, fname_val, y_train, y_val = train_test_split(label_df['fname'], label_df['liveness_score'], test_size=0.33, random_state=42, stratify=label_df['liveness_score'])
